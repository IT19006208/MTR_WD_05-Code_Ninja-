...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private String CategoryName,Description, Price, Pname, saveCurrentData, saveCurrenTime;
    ...
    private void StoreProductInformation() {
        ...
        saveCurrenTime = currentData.format(calendar.getTime());

        productRandomKey = saveCurrentData + saveCurrenTime;
